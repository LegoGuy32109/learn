    ...
    components: {
      ...
      securitySchemes: {
        bearer: {
          ...
          description: "A personal access token minted by the site owner. Scopes: lessons:read for GET routes, lessons:write for POST routes. Agents read it from the LEARN_TOKEN environment variable and never print it.",
        },
      },
      schemas: {
