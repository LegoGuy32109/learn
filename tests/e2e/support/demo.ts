...
export const ANSWERS: Answer[] = [
  {
    fragment: "current age of 20 seconds",
    option: "Reuse the stored response without contacting the origin at all.",
  },
  { fragment: "max-age=300 and Age: 120", text: "180" },
  { fragment: "already spent in caches", text: "Age" },
  {
    fragment: "current age of 90 seconds",
    option:
      "Send a conditional request and reuse the stored body only on a 304.",
  },
  {
    fragment: 'still has ETag "v7"',
    option:
      "The origin answers 304 Not Modified and the cache keeps serving its stored body.",
  },
  { fragment: "carries a stored ETag", text: "If-None-Match" },
  { fragment: "kilobytes of body", text: "200" },
  {
    fragment: 'now has ETag "v8"',
    option:
      "The origin answers 200 with a complete body and the cache replaces its stored copy.",
  },
  {
    fragment: "Cache-Control: no-store",
    option:
      "Do not keep any copy of the response in the cache, not even briefly.",
  },
  {
    fragment: "must-revalidate require",
    option:
      "Keep a copy, but once stale never serve it without a successful check.",
  },
